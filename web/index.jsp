    ...
    <div class="mainContent">
        ...
        <div class="subContent">
            ...
            <div class="para-content">
                ...
                <p>Students, register now to test your knowledge in the basics of Math.</p>
                <p>Teachers, manage your students performance and be their guide to improve in the subject</p>
            </div>
        </div>
